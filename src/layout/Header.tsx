  ...
  return (
    <header className="sticky top-0 z-40 border-b border-navy-100 bg-white/90 backdrop-blur">
      <div className="container-x flex h-20 items-center justify-between">
        <Link
          href="/"
          className="group flex items-center gap-2.5 rounded-lg p-1.5 transition-all duration-200 hover:bg-slate-50"
          aria-label={BRAND.name}
        >
          {/* Green glow effect on the icon when hovering the link */}
          <div className="text-emerald-600 transition-transform duration-300 group-hover:scale-110 group-hover:drop-shadow-[0_0_8px_rgba(5,150,105,0.4)]">
            {/* <StarMark /> */}
          </div>
          <span className=" font-extrabold tracking-tight text-slate-800 text-3xl">
            Elmo<span className="text-emerald-600 font-normal"> Loans</span>
          </span>
        </Link>
