...
export default function LoanUsesHero() {
  return (
    <section className="relative overflow-hidden bg-black">
      ...
      <div className="container-x relative py-12 md:py-20 text-center">
        ...
        <h1 className="mt-6 text-4xl font-bold text-white md:text-5xl">
          What You Can Use an Elmo Loans Business Loan For
        </h1>

        <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">
          Your business, your call. We fund a wide range of legitimate business
          purposes.
        </p>
      </div>
    </section>
